          ...
          <ul className={styles.servisesList}>
            <li className={styles.servisesItem}>
              <p className={styles.servisesP}>
                Lorem ipsum dolor sit amet. Ut galisum corporis est sunt
                excepturi et praesentium eligendi eum recusandae quisquam et
                velit nisi. Qui aspernatur libero ut placeat Quis ad expedita
                iure vel accusamus dolor qui sequi incidunt et tempore vero. Sit
                soluta totam ut sapiente delectus vel fuga rerum ad voluptates
                sunt ut consequatur facere aut vitae accusantium qui voluptas
                voluptas.
              </p>
            </li>
            <li className={styles.servisesItem}>
